...
function createLogo(answers) {
    ...
    switch (answers.logoShape) {
        ...
        case "Circle": 
            ...
            chosenShape = new Circle (answers.logoName, answers.chosenTextColor, answers.chosenShapeColor)
            return chosenShape.render()
            break;
        
        case "Square": 

            chosenShape = new Square (answers.logoName, answers.chosenTextColor, answers.chosenShapeColor)
            return chosenShape.render()
            break; 
    
        case "Triangle": 

            chosenShape = new Triangle (answers.logoName, answers.chosenTextColor, answers.chosenShapeColor)
            return chosenShape.render()
            break;

        case "InvTriange": 

            chosenShape = new InvTriangle (answers.logoName, answers.chosenTextColor, answers.chosenShapeColor)
            return chosenShape.render()
            break;
        
        case "Square": 

            chosenShape = new Ellipse (answers.logoName, answers.chosenTextColor, answers.chosenShapeColor)
            return chosenShape.render()
            break; 
